    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <x-nav-link :href="route('login')" :active="request()->routeIs('login')" wire:navigate class="h-full px-3">
                        {{ __('Login') }}
                    </x-nav-link>
                @endif
                <x-nav-link :href="route('cart')" :active="request()->routeIs('cart')" class="h-full px-3">
